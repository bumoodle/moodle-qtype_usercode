...
/**
 * Upgrade library code for the usercode question type.
 *
 * @package    qtype
 * @subpackage usercode
...
/**
 * Class for converting attempt data for usercode questions when upgrading
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_usercode_qe2_attempt_updater extends question_qtype_attempt_updater {
