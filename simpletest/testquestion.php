 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_usercode_question_test extends UnitTestCase {
    public function test_is_complete_response() {
        $question = test_question_maker::make_question('usercode', 'true');
    ...
    public function test_get_question_summary() {
        $tf = test_question_maker::make_question('usercode', 'true');
    ...
    public function test_summarise_response() {
        ...
        $this->assertEqual(get_string('false', 'qtype_usercode'),
                $tf->summarise_response(array('answer' => '0')));

        $this->assertEqual(get_string('true', 'qtype_usercode'),
    ...
    public function test_classify_response() {
        ...
        $this->assertEqual(array(
                $tf->id => new question_classified_response(
                        0, get_string('false', 'qtype_usercode'), 0.0)),
                $tf->classify_response(array('answer' => '0')));
        $this->assertEqual(array(
                $tf->id => new question_classified_response(
                        1, get_string('true', 'qtype_usercode'), 1.0)),
